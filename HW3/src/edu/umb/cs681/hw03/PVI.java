	...
	public static void readCSV() {
        ...
        Path path = Paths.get (pathName);
		        try (Stream<String> lines = Files.lines(path)) {
		            ...
		            List Berkshire = matrix.stream().filter((i) -> i.get(5).contains("Berkshire")).collect(Collectors.toList()).get(0);
		            System.out.println("1. Number of deaths in Berkshire county of the Massachusetts are: " + Berkshire.get(7));
